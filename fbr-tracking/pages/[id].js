  ...
  return (
    <div style={styles.pageWrapper}>
      <Head>
        ...
        {/* Fontes: Inter (Moderno/Apple) + Cormorant Garamond (Toque Floral) */}
        <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600&family=Cormorant+Garamond:wght@400;500;600&display=swap" rel="stylesheet" />
      </Head>
      ...
      <div style={styles.card}>
        ...
        <main>
          ...
          <div style={styles.statusBox}>
            ...
            {/* Última Atualização (Discreto e elegante) */}
            <div style={styles.updateRow}>
               <span style={styles.updateLabel}>Atualizado em / Updated:</span>
               <span style={styles.updateDate}>{encomenda.ultima_atualizacao}</span>
            </div>
          </div>

          {/* DATA ENTREGA (Centrado) */}
          ...
          <div style={styles.actionSection}>
            ...
            {/* WhatsApp (Agora Preto/Carvão - Luxo) */}
...
// --- ESTILOS "SERENE LUXURY" ---
const styles = {
  pageWrapper: {
    minHeight: '100vh',
    // AQUI ESTÁ A COR DO FUNDO: 
    // #AAB7B0 = Eucalipto Seco (Verde acinzentado suave)
    // #D8D4CE = Areia Quente
    // #BCC4C9 = Azul Acinzentado
  ...
  card: {
    ...
    maxWidth: '460px',
    padding: '45px 30px',
    // Sombra mais profunda para contrastar com o fundo colorido
    boxShadow: '0 20px 40px rgba(0, 0, 0, 0.1)', 
    borderRadius: '16px', // Um pouco menos redondo = mais sério/premium
    textAlign: 'center',
  },
  ...
  tagline: {
    ...
    color: '#9CA69D', // Um verde muito subtil
    marginTop: '6px',
    fontWeight: '700',
  },
  ...
  // STATUS BOX
  statusBox: {
    backgroundColor: '#F9F9F9', // Quase branco
    padding: '30px 25px',
    borderRadius: '12px',
    marginBottom: '35px',
    textAlign: 'left',
  ...
  statusMainText: {
    ...
    fontSize: '22px',
    fontWeight: '600',
    color: '#2C3E30', // Verde Floresta Profundo (quase preto)
    marginBottom: '15px',
  },
  message: {
    fontSize: '15px',
  ...
  deliveryDate: {
    ...
    fontSize: '26px',
    fontWeight: '500',
    color: '#2C3E30', // Verde Floresta Profundo
    margin: 0,
  },
  ...
  // Botão "Charcoal" (Preto Carvão)
  buttonAction: {
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'center',
    backgroundColor: '#2C2C2C', // O tal Preto Suave
    color: '#FFFFFF',
    textDecoration: 'none',
    padding: '16px',
    borderRadius: '50px', // Forma de Pílula (Pill Shape)
    fontSize: '14px',
    fontWeight: '500',
