    ...
    return (
      <div style={s.pageWrapper}>
        ...
        <div style={s.card}>
          ...
          <div style={s.body}>
            <div style={{marginTop:'4px',marginBottom:'40px'}}>
          ...
          <footer style={s.footer}><p style={s.copyright}>© Flores à Beira-Rio</p></footer>
        </div>
      </div>
    );
  }
...
const s = {
  ...
  statusMainTextEn: { fontFamily:'"TanMemories", serif', fontSize:'26px', fontStyle:'italic', color:'#6D8C78', lineHeight:'1.1' },
  ...
  deliveryContainer: { marginBottom:'36px' },
  ...
  actionSection: { display:'flex', flexDirection:'column', gap:'12px', marginBottom:'10px' },
